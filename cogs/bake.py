...
class Bakery(commands.Cog):
  ...
  @commands.group(invoke_without_command =True, help = "Commands for viewing/managing your bakery.")
  ...
  @bakery.command(name = "start", help = "Open a bakery.")
  ...
  @bakery.command(name = "view", aliases = ["profile"], help = "View your bakery!")
